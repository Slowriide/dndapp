...
class WarlockFeaturesTable extends StatelessWidget {
  final List<LevelPerClass>? levels;

  const WarlockFeaturesTable({
    super.key,
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(
            label: Text('ELDRICH INVOCATIONS', style: title),
          ),
          DataColumn(
          ...
          DataColumn(
            label: Text('SPELL SLOTS', style: title),
          ),
          DataColumn(
            label: Text('SLOT LEVEL', style: title),
          ),
        ],
        rows: levels!.map((level) {
          return DataRow(cells: [
            ...
            //Sorcery points
            DataCell(
              Text(level.classSpecific?.invocationsKnown.toString() ?? 'N/A'),
            ),
            //Cantrips
            DataCell(
