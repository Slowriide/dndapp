...
class BardFeaturesTable extends StatelessWidget {
  final List<LevelPerClass>? levels;

  const BardFeaturesTable({
    super.key,
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(
            label: Text('BARDIC DIE', style: title),
          ),
          DataColumn(
        ...
        rows: levels!.map((level) {
          return DataRow(cells: [
            ...
            //Bardic die
            DataCell(
              Text(level.classSpecific?.bardicInspirationDie.toString() ??
                  'N/A'),
            ),
            //Cantrips
            DataCell(
