...
class DruidFeaturesTable extends StatelessWidget {
  final List<LevelPerClass>? levels;

  const DruidFeaturesTable({
    super.key,
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(
            label: Text('WILD SHAPE', style: title),
          ),
          DataColumn(
        ...
        rows: levels!.map((level) {
          return DataRow(cells: [
            ...
            //Wild Shape
            DataCell(
              Text(level.classSpecific?.wildShapeMaxCr.toString() ?? 'N/A'),
            ),
            //Cantrips
            DataCell(
