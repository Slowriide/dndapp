...
class PaladinFeaturesTable extends StatelessWidget {
  final List<LevelPerClass>? levels;

  const PaladinFeaturesTable({
    super.key,
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(
            label: Text('CHANNEL DIVINITY', style: title),
          ),
          DataColumn(
        ...
        rows: levels!.map((level) {
          return DataRow(cells: [
            ...
            //Chanel divinity
            DataCell(
              Text(level.classSpecific?.channelDivinityCharges.toString() ??
                  'N/A'),
            ),
            //Prepared spells
            DataCell(
