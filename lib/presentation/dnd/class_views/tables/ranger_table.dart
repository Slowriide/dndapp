...
class RangerFeaturesTable extends StatelessWidget {
  final List<LevelPerClass>? levels;

  const RangerFeaturesTable({
    super.key,
    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(
            label: Text('FAVORED ENEMY', style: title),
          ),
          DataColumn(
        ...
        rows: levels!.map((level) {
          return DataRow(cells: [
            ...
            //Chanel divinity
            DataCell(
              Text(level.classSpecific?.favoredEnemies.toString() ?? 'N/A'),
            ),
            //Prepared spells
            DataCell(
